...
file = cv2.imread("real_sample.jpg")
...
for key in dict_words.keys():
    ...
    dict_words[key] = {"text_list" : list_text , "min_left" : min_left , "min_top" : min_top , "max_left_plus_width" : max_left_plus_width , "max_top_plus_height" : max_top_plus_height , "extended_right" : max_left_plus_width +  min_left}
